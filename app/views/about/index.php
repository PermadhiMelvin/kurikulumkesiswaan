...
<div class="container">
    <div class="p-5 mb-4 bg-light rounded-3 mt-5">
      ...
      <h1>Tentang Humas</h1>
        <br>
        <br>
        <p class="justify"><strong>HUMAS dan HI SMKN 4 Malang </strong>yang di pimpin oleh Ibu Tisna Hestiningtyas, M.Pd. melaksanakan fungsinya sebagai penghubung antara sekolah dengan Dudika (Dunia Usaha dan Dunia Industri ) serta lembaga pemerintah, swasta dan masyarakat. Tugas pokok lainnya adalah memelihara dan mengembangkan hubungan sekolah dengan Dudi salah satunya adalah Prakerin (Praktek Kerja Industri)/PKL (Praktik Kerja Lapangan) yang merupakan kegiatan pendidikan, pelatihan dan pembelajaran yang dilaksanakan di Dunia Usaha Atau Dunia Industri dalam upaya pendekatan ataupun untuk meningkatkan mutu siswa – siswi Sekolah Menengah Kejuruan (SMK) dengan kompetensi (kemampuan) siswa sesuai bidangnya dan juga menambah bekal untuk masa – masa mendatang guna memasuki dunia kerja yang semangkin banyak serta ketat dalam persaingannya seperti di masa sekarang ini </p>
